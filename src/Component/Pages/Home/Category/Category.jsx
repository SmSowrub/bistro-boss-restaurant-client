    ...
    return (
        ...
        <div>
            <div className="w-52 mx-auto">
                <p className="text-warning italic font-[Inter] border-b-2 pb-4 my-3 border-gray-400">---From 11:00am to 10:00pm---</p> 
                <h2 className="text-center border-b-2 font-[Inter] pb-4 border-gray-400 ">ORDER ONLINE</h2>
            </div>
        <Swiper
        slidesPerView={4}
        spaceBetween={30}
